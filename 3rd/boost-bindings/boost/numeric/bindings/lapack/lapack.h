...
extern "C" {
  ...
  void LAPACK_SGETRI (int const* n, float const* a, int const* lda, 
	                  int const* ipiv, float const* work, int const* lwork,
                      int* info);
  void LAPACK_DGETRI (int const* n, double const* a, int const* lda, 
	                  int const* ipiv, double const* work, int const* lwork,
                      int* info);
  void LAPACK_CGETRI (int const* n, fcomplex_t const* a, int const* lda, 
	                  int const* ipiv, fcomplex_t const* work, int const* lwork,
                      int* info);
  void LAPACK_ZGETRI (int const* n, dcomplex_t const* a, int const* lda, 
	                  int const* ipiv, dcomplex_t const* work, int const* lwork,
                      int* info);					  

  void LAPACK_STRTRI (char const* uplo, const char* diag, int const* n, 
                      float* a, int const* lda, int* info);
  void LAPACK_DTRTRI (char const* uplo, const char* diag, int const* n, 
                      double* a, int const* lda, int* info);
  void LAPACK_CTRTRI (char const* uplo, const char* diag, int const* n, 
                      fcomplex_t* a, int const* lda, int* info);
  void LAPACK_ZTRTRI (char const* uplo, const char* diag, int const* n, 
                      dcomplex_t* a, int const* lda, int* info);

  /* least square */

  void LAPACK_SGELS (char const* trans, int const* m, int const* n, int const* nrhs, 
                     float* a, int const* lda, float* b, int const* ldb, 
					 float* work, int const* lwork, int* info);
  void LAPACK_DGELS (char const* trans, int const* m, int const* n, int const* nrhs, 
                     double* a, int const* lda, double* b, int const* ldb, 
					 double* work, int const* lwork, int* info);
  void LAPACK_CGELS (char const* trans, int const* m, int const* n, int const* nrhs, 
                     fcomplex_t* a, int const* lda, fcomplex_t* b, int const* ldb, 
					 fcomplex_t* work, int const* lwork, int* info);
  void LAPACK_ZGELS (char const* trans, int const* m, int const* n, int const* nrhs, 
                     dcomplex_t* a, int const* lda, dcomplex_t* b, int const* ldb, 
					 dcomplex_t* work, int const* lwork, int* info);
					 
  void LAPACK_SGELSS (int const* m, int const* n, int const* nrhs, 
                     float* a, int const* lda, float* b, int const* ldb, 
					 float* s, const float* rcond, int* rank,
					 float* work, int const* lwork, int* info);
  void LAPACK_DGELSS (int const* m, int const* n, int const* nrhs, 
                     double* a, int const* lda, double* b, int const* ldb, 
					 double* s, const double* rcond, int* rank,
					 double* work, int const* lwork, int* info);
  void LAPACK_CGELSS (int const* m, int const* n, int const* nrhs, 
                     fcomplex_t* a, int const* lda, fcomplex_t* b, int const* ldb, 
					 float* s, const float* rcond, int* rank,
					 fcomplex_t* work, int const* lwork, float* rwork, int* info);
  void LAPACK_ZGELSS (int const* m, int const* n, int const* nrhs, 
                     dcomplex_t* a, int const* lda, dcomplex_t* b, int const* ldb, 
					 double* s, const double* rcond, int* rank,
					 dcomplex_t* work, int const* lwork, double* rwork, int* info);
  ...
  void LAPACK_SPOTRI (char const* uplo, int const* n, 
                      float* a, int const* lda, int* info);
  void LAPACK_DPOTRI (char const* uplo, int const* n, 
                      double* a, int const* lda, int* info);
  void LAPACK_CPOTRI (char const* uplo, int const* n, 
                      fcomplex_t* a, int const* lda, int* info);
  void LAPACK_ZPOTRI (char const* uplo, int const* n, 
                      dcomplex_t* a, int const* lda, int* info);
  ...
  void LAPACK_SGEQR2( const int* m, const int* n, float* a, const int* lda,
                      float* tau, float* work, int* info );
  void LAPACK_DGEQR2( const int* m, const int* n, double* a, const int* lda,
                      double* tau, double* work, int* info );
  void LAPACK_CGEQR2( const int* m, const int* n, fcomplex_t* a, const int* lda,
                      fcomplex_t* tau, fcomplex_t* work, int* info );
  void LAPACK_ZGEQR2( const int* m, const int* n, dcomplex_t* a, const int* lda,
                      dcomplex_t* tau, dcomplex_t* work, int* info );
  ...
  void LAPACK_SGERQF( const int* m, const int* n, float* a, const int* lda,
                      float* tau, float* work, const int* lwork, int* info );
  void LAPACK_DGERQF( const int* m, const int* n, double* a, const int* lda,
                      double* tau, double* work, const int* lwork, int* info );
  void LAPACK_CGERQF( const int* m, const int* n, fcomplex_t* a, const int* lda,
                      fcomplex_t* tau, fcomplex_t* work, const int* lwork, int* info );
  void LAPACK_ZGERQF( const int* m, const int* n, dcomplex_t* a, const int* lda,
                      dcomplex_t* tau, dcomplex_t* work, const int* lwork, int* info );

  void LAPACK_SGERQ2( const int* m, const int* n, float* a, const int* lda,
                      float* tau, float* work, int* info );
  void LAPACK_DGERQ2( const int* m, const int* n, double* a, const int* lda,
                      double* tau, double* work, int* info );
  void LAPACK_CGERQ2( const int* m, const int* n, fcomplex_t* a, const int* lda,
                      fcomplex_t* tau, fcomplex_t* work, int* info );
  void LAPACK_ZGERQ2( const int* m, const int* n, dcomplex_t* a, const int* lda,
                      dcomplex_t* tau, dcomplex_t* work, int* info );

  void LAPACK_SORGRQ( const int* m, const int* n, const int* k, float* a, const int* lda,
                      float* tau, float* work, const int* lwork, int* info );
  void LAPACK_DORGRQ( const int* m, const int* n, const int* k, double* a, const int* lda,
                      double* tau, double* work, const int* lwork, int* info );
  void LAPACK_CUNGRQ( const int* m, const int* n, const int* k, fcomplex_t* a, const int* lda,
                      fcomplex_t* tau, fcomplex_t* work, const int* lwork, int* info );
  void LAPACK_ZUNGRQ( const int* m, const int* n, const int* k, dcomplex_t* a, const int* lda,
                      dcomplex_t* tau, dcomplex_t* work, const int* lwork, int* info );

  void LAPACK_SORGR2( const int* m, const int* n, const int* k, float* a, const int* lda,
                      float* tau, float* work, int* info );
  void LAPACK_DORGR2( const int* m, const int* n, const int* k, double* a, const int* lda,
                      double* tau, double* work, int* info );
  void LAPACK_CUNGR2( const int* m, const int* n, const int* k, fcomplex_t* a, const int* lda,
                      fcomplex_t* tau, fcomplex_t* work, int* info );
  void LAPACK_ZUNGR2( const int* m, const int* n, const int* k, dcomplex_t* a, const int* lda,
                      dcomplex_t* tau, dcomplex_t* work, int* info );

...
namespace boost { namespace numeric { namespace bindings { 
  ...
  namespace lapack {
    ...
    /*
     * getri() inverts a matrix A using  
     * the LU factorization computed by getrf().
     */
    ...
    namespace detail {
      ...
      inline 
      void getri (int const n, float const* a, int const lda, 
      ...
      inline 
      void getri (int const n, double const* a, int const lda, 
      ...
      inline 
      void getri (int const n, traits::complex_f const* a, int const lda, 
	              int const* ipiv, traits::complex_f const* work, int const lwork,
                  int* info) 
      {
        LAPACK_CGETRI (&n, traits::complex_ptr (a), &lda, ipiv, traits::complex_ptr (work), &lwork, info);
      }

	  
      inline 
      void getri (int const n, traits::complex_d const* a, int const lda, 
	              int const* ipiv, traits::complex_d const* work, int const lwork,
                  int* info) 
      {
        LAPACK_ZGETRI (&n, traits::complex_ptr (a), &lda, ipiv, traits::complex_ptr (work), &lwork, info);
      }

    }

    template <typename MatrA, typename IVec, typename WVec>
    inline
    int getri (MatrA& a, IVec& ipiv, WVec& wvec) {
      ...
      assert (traits::vector_size (ipiv) == o);
      assert (traits::vector_size (wvec) >= o);
      ...
      detail::getri (o, 
                     ...
                     traits::leading_dimension (a),
                     traits::vector_storage (ipiv),
                     traits::vector_storage (wvec),
                     traits::vector_size (wvec),
                     &info);
      return info; 
    }

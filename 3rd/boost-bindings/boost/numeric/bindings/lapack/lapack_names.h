...
#define LAPACK_SGEQR2 FORTRAN_ID( sgeqr2 )
#define LAPACK_DGEQR2 FORTRAN_ID( dgeqr2 )
#define LAPACK_CGEQR2 FORTRAN_ID( cgeqr2 )
#define LAPACK_ZGEQR2 FORTRAN_ID( zgeqr2 )
...
#define LAPACK_SGERQ2 FORTRAN_ID( sgerq2 )
#define LAPACK_DGERQ2 FORTRAN_ID( dgerq2 )
#define LAPACK_CGERQ2 FORTRAN_ID( cgerq2 )
#define LAPACK_ZGERQ2 FORTRAN_ID( zgerq2 )
...
#define LAPACK_SORGR2 FORTRAN_ID( sorgr2 )
#define LAPACK_DORGR2 FORTRAN_ID( dorgr2 )
#define LAPACK_CUNGR2 FORTRAN_ID( cungr2 )
#define LAPACK_ZUNGR2 FORTRAN_ID( zungr2 )

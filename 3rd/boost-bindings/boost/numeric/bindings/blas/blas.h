...
extern "C"
{
  ...
  void BLAS_SSYMM( const char* side, const char* uplo, const int* m, const int* n, const float* alpha, const float* a_ptr,
                   const int* lda, const float* b_ptr, const int* ldb, const float* beta, const float* c_ptr,
  		 	       const int* ldc );
  void BLAS_DSYMM( const char* side, const char* uplo, const int* m, const int* n, const double* alpha, const double* a_ptr,
                   const int* lda, const double* b_ptr, const int* ldb, const double* beta, const double* c_ptr,
  		 	       const int* ldc );
  void BLAS_CSYMM( const char* side, const char* uplo, const int* m, const int* n, const fcomplex_t* alpha, const fcomplex_t* a_ptr,
                   const int* lda, const fcomplex_t* b_ptr, const int* ldb, const fcomplex_t* beta, const fcomplex_t* c_ptr,
  		 	       const int* ldc );
  void BLAS_ZSYMM( const char* side, const char* uplo, const int* m, const int* n, const dcomplex_t* alpha, const dcomplex_t* a_ptr,
                   const int* lda, const dcomplex_t* b_ptr, const int* ldb, const dcomplex_t* beta, const dcomplex_t* c_ptr,
  		 	       const int* ldc );

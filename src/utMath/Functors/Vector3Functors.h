 ...
 * std::vector of Math::Vectors< T, 3 > using std::transform.
 *
 ...
 * transforms a Math::Vector< T, 3 > by a given 3x3 transformation-matrix.
 */
 ...
 * @ingroup math
 * Functor Class for STL algorithms.
 * transforms a Math::Vector< T, 3 > by a given 3x4 transformation-matrix
 */
 ...
 * @ingroup math
 * Functor Class for STL algorithms.
 * Projects a Math::Vector< T, 3 > with a 4x4 projection-matrix.
 */
...
public:
	/**
	 * @ingroup math
	 * Projects the Math::Vector< T, 3 > with a 4x4 projection-matrix(e.g. a 4x4-homography).
	 *
	...
	Math::Vector< T, 3 > operator() ( const Math::Matrix< T, 4, 4 > &projection, const Math::Vector< T, 3 > &vec ) const
    {
		...
		return Math::Vector< T, 3 > ( e1*e4, e2*e4, e3*e4 );
	}
};
 ...
 * @ingroup math
 * Functor Class for STL algorithms.
 * Calculates the norm of a Math::Vector< T, 3 >.
 */
 
template< typename T >
struct norm_vector3
	: public std::unary_function< Math::Vector< T, 3 >, T >
{
public:
	/**
	 * @ingroup math
	 ...
	 */
	T operator() ( const Math::Vector< T, 3 >& v ) const
    {
 ...
 * @ingroup math
 * Functor Class for STL algorithms.
 * Normalizes the Math::Vector< T, 3 >.
 */
 
template< typename T >
struct normalize_vector3
	: public std::unary_function< Math::Vector< T, 3 >, Math::Vector< T, 3 > >
{
public:
	/**
	 * @ingroup math
	 ...
	 */
	Math::Vector< T, 3 > operator() ( const Math::Vector< T, 3 >& v ) const
    {
...
struct homogenize_vector3
	: public std::unary_function< Math::Vector< T, 2 >, Math::Vector< T, 3 > >
{
public:
	/**
	 * @ingroup math
	 ...
	 */
	Math::Vector< T, 3 > operator()( const Math::Vector< T, 2 > &vec ) const
	{
		return Math::Vector< T, 3 >( vec( 0 ), vec( 1 ), 1 );
	}
};
...
struct dehomogenize_vector3
	: public std::unary_function< Math::Vector< T, 3 >, Math::Vector< T, 2 > >
{
public:
	/**
	 * @ingroup math
	 ...
	 * @return 2-vector
	 */
	Math::Vector< T, 2 > operator()( const Math::Vector< T, 3 > &vec ) const
	{
		return Math::Vector< T, 2 >( vec( 0 ), vec( 1 ) );
	}
};
 ...
 * @ingroup math
 * Functor Class for STL algorithms.
 * Calculates the euclidean distance of two Math::Vector< T, 3 >.
 */
 
template< typename T >
struct euclidean_distance_vector3
	: public std::binary_function< Math::Vector< T, 3 >, Math::Vector< T, 3 >, T >
{
public:
	/**
	 * @ingroup math
	 ...
	 */
	T operator()( const Math::Vector< T, 3 > &v1, const Math::Vector< T, 3 > &v2 ) const
	{
		const T x = v1( 0 ) - v2( 0 );
		const T y = v1( 1 ) - v2( 1 );
		const T z = v1( 2 ) - v2( 2 );
 ...
 * @ingroup math
 * Functor Class for STL algorithms.
 * Constructs the antisymmetric-skew matrix from a Math::Vector< T, 3 >.
 */
 ...
 * @ingroup math
 * Functor Class for STL algorithms.
 * Constructs a new Math::Vector< T, 3 > as the cross-product of two Math::Vector< T, 3 >.
 */
 
template< typename T >
struct cross_product
	: public std::binary_function< Math::Vector< T, 3 >, Math::Vector< T, 3 >, Math::Vector< T, 3 > >
{
public:
	/**
	 * @ingroup math
	 ...
	 */
	Math::Vector< T, 3 > operator() ( const Math::Vector< T, 3 >& a, const Math::Vector< T, 3 > &b ) const
    {

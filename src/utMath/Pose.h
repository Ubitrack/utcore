...
class UBITRACK_EXPORT Pose
{
	...
	public:		
		...
		Pose()
			: m_rotation( )
			, m_translation ( Vector < 3 > ( 0.0, 0.0, 0.0 ))
		{}
		 ...
		 */
		Pose( const Quaternion& q, const Vector< 3 >& t )
			: m_rotation( q )
			, m_translation( t )
		{}
		...
		{ return Pose( Quaternion::fromVector( boost::numeric::ublas::subrange( v, 3, 7 ) ), Vector< 3 >( v( 0 ), v( 1 ), v( 2 ) ) ); }

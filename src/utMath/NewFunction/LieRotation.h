 ...
 */
class LieRotation
	: public MultiVariateFunction< LieRotation, 3 >
{
public:

	template< class DestinationVector, class Param1, class Param2 >
	void evaluate( DestinationVector& result, const Param1& rotation, const Param2& point ) const
	{
		result = Math::Quaternion::fromLogarithm( rotation ) * point;
	}
	...
	void multiplyJacobian1( const LeftHand& l, DestinationMatrix& j, const Param1& rotation, const Param2& point ) const
	{
		...
		VType t51946 = rotation( 1 );
		VType t51947 = t51946 * t51946;
		VType t51948 = rotation( 2 );
		...
		else
		{
			...
			VType t51955 = point( 1 );
			VType t51957 = point( 2 );

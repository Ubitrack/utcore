...
template< typename T >
T pointToPointDistImp( const Math::Vector< T, 3 > & from, const Math::Vector< T, 3 > & to, const Math::Matrix< 3, 3, T > & fM  )
{
...
float pointToPointDist( const Math::Vector< float, 2 > & from, const Math::Vector< float, 2 > & to, const Math::Matrix< 3, 3, float > & fM  )
{
...
double pointToPointDist( const Math::Vector< double, 2 > & from, const Math::Vector< double, 2 > & to, const Math::Matrix< 3, 3, double > & fM  )
{
...
float pointToPointDist( const Math::Vector< float, 3 > & from, const Math::Vector< float, 3 > & to, const Math::Matrix< 3, 3, float > & fM  )
{
	return pointToPointDistImp( from, to, fM );
}

double pointToPointDist( const Math::Vector< double, 3 > & from, const Math::Vector< double, 3 > & to, const Math::Matrix< 3, 3, double > & fM  )
{
	return pointToPointDistImp( from, to, fM );
}
...
#ifdef HAVE_LAPACK
template< typename T >
Math::Vector< T, 3 > get3DPositionImpl( const Math::Matrix< 3, 4, T > & P1, const Math::Matrix< 3, 4, T > & P2, const Math::Vector< T, 2 > & x, const Math::Vector< T, 2 > & x_ )
{
	Math::Matrix< 4, 4, T > A;
...
Math::Vector< float, 3 > get3DPosition( const Math::Matrix< 3, 4, float > & P1, const Math::Matrix< 3, 4, float > & P2, const Math::Vector< float, 2 > & x, const Math::Vector< float, 2 > & x_ )
{
	return get3DPositionImpl< float >( P1, P2, x, x_ );
}

Math::Vector< double, 3 > get3DPosition( const Math::Matrix< 3, 4, double > & P1, const Math::Matrix< 3, 4, double > & P2, const Math::Vector< double, 2 > & x, const Math::Vector< double, 2 > & x_ )
{
...
Math::Vector< float, 3 > get3DPosition( const std::vector< Math::Matrix< 3, 4, float > > &P, const std::vector< Math::Vector< float, 2 > > &points, std::size_t flag )
{
...
Math::Vector< double, 3 > get3DPosition( const std::vector< Math::Matrix< 3, 4, double > > &P, const std::vector< Math::Vector< double, 2 > >& points, std::size_t flag )
{
	if( P.size() != points.size() )
		UBITRACK_THROW( "no equal amount of camera projections and corresponding points." );
...
Math::Vector< double, 3 > get3DPositionWithResidual( const std::vector< Math::Matrix< 3, 4, double > > &P, const std::vector< Math::Vector< double, 2 > >& points, std::size_t flag, double* pResidual )
{
	if( P.size() != points.size() )
		UBITRACK_THROW( "no equal amount of camera projections and corresponding points." );
	Math::Vector< double, 3 > result = get3DPositionImpl( P.begin(), P.end(), points.begin() );

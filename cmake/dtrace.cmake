...
MACRO (DTRACE_HEADER provider header header_no_dtrace)
 ...
 ADD_CUSTOM_COMMAND(
   ...
   COMMAND perl ${CMAKE_CURRENT_SOURCE_DIR}/doc/tracing/dtrace/dheadgen.pl -f ${provider} > ${header_no_dtrace}
   DEPENDS ${provider}
 )
 ENDIF()
ENDMACRO()
...
IF(ENABLE_DTRACE)
  CONFIGURE_FILE(${CMAKE_CURRENT_SOURCE_DIR}/doc/tracing/dtrace/probes_ubitrack_dtrace.d.base

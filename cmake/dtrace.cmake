...
MACRO (DTRACE_HEADER provider header header_no_dtrace)
 ...
 ADD_CUSTOM_COMMAND(
   ...
   COMMAND perl ${INSTRUMENTATION_SOURCE_FOLDER}/dtrace/dheadgen.pl -f ${provider} > ${header_no_dtrace}
   DEPENDS ${provider}
 )
 ENDIF()
ENDMACRO()
...
IF(ENABLE_DTRACE)
  CONFIGURE_FILE(${INSTRUMENTATION_SOURCE_FOLDER}/dtrace/probes_ubitrack_dtrace.d.base

...
if(WIN32)
  ...
  set(UBITRACK_COMPILE_DEFINITIONS "WIN32" "_MBCS")  
  ...
  IF(BUILD_SHARED_LIBS)
    string(TOUPPER "${UTCORE_LIBRARY}" _libname_upper)
...
if(WIN32)
  # Postfix of DLLs:
  set(UBITRACK_DLLVERSION "${UBITRACK_VERSION_MAJOR}${UBITRACK_VERSION_MINOR}${UBITRACK_PATCH_VERSION}")
...
SET(UBITRACK_LIBVERSION "${UBITRACK_VERSION_MAJOR}.${UBITRACK_VERSION_MINOR}.${UBITRACK_PATCH_VERSION}")

...
@rem xperf -on %KernelProviders% %KernelStackWalk% %KBuffers% -f %kernelfile% -start %SessionName% -on %UserProviders%+%CustomProviders% -f %userfile%
xperf -on PROC_THREAD %KernelStackWalk% %KBuffers% -f %kernelfile% -start %SessionName% -on %CustomProviders% -f %userfile%
...
@rem xperf -on %KernelProviders% %KernelStackWalk% %KBuffers% -f %kernelfile%  -start %SessionName% -on %UserProviders% -f %userfile%
xperf -on PROC_THREAD %KernelStackWalk% %KBuffers% -f %kernelfile%  -start %SessionName% -on %CustomProviders% -f %userfile%
...
@pushd %batchdir%
@rem XXX python StripChromeSymbols.py %FileName%
@popd
start wpa %FileName%
